...
<head>
    ...
    <title>{{ config('app.name') }} - Comprobación Aprobada por Autorizador Mayor</title>
    <style>
        body {
...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="message">
                <p>Le informamos que su comprobación de gastos ha sido aprobada por el Autorizador Mayor. El proceso de revisión ha finalizado exitosamente.</p>
            </div>

            <div class="success-box">
                <p><strong>Su comprobación de gastos ha sido aprobada por el Autorizador Mayor</strong></p>
            </div>
            ...
            <div class="details-box">
                ...
                <div class="details-row">
                    ...
                    <span class="details-value">{{ $verification->approver->name }} (Autorizador Mayor)</span>
                </div>
                <div class="details-row">
                    <span class="details-label">
                        <svg class="icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="notes-box">
                <h3>Comentarios del Autorizador</h3>
