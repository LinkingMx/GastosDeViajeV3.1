...
<head>
    ...
    <title>{{ config('app.name') }} - Comprobación de Gastos Enviada</title>
    <style>
        body {
...
<body>
    <div class="container">
        ...
        <div class="header">
            ...
            <h1>Comprobación de Gastos Enviada</h1>
        </div>
        ...
        <div class="content">
            ...
            <div class="message">
                <p>Se ha recibido una nueva comprobación de gastos que requiere su revisión.</p>

                <p>A continuación se presentan los detalles:</p>
            </div>
            ...
            <div class="details-box">
                ...
                <div class="details-row">
                    ...
                    <span class="details-value">{{ $verification->creator->name }}</span>
                </div>
                ...
                <div class="details-row">
                    ...
                    <span class="details-value">{{ $verification->submitted_at->format('d/m/Y H:i') }}</span>
                </div>
