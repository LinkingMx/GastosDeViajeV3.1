...
<head>
    ...
    <title>{{ config('app.name') }} - Comprobación Rechazada</title>
    <style>
        body {
...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="message">
                <p>Le informamos que su comprobación de gastos ha sido revisada y no ha sido aprobada.</p>
            </div>

            <div class="rejection-box">
                <p><strong>Su comprobación de gastos no ha sido aprobada</strong></p>
            </div>
            ...
            <div class="details-box">
                ...
                <div class="details-row">
                    ...
                    <span class="details-value">{{ $verification->rejected_at->format('d/m/Y H:i') }}</span>
                </div>
            </div>
            ...
            <div style="text-align: center; margin: 40px 0;">
                <a href="{{ $url }}" class="cta-button">
                    Ver Detalles de la Comprobación
                </a>
            </div>
            ...
            <div class="message">
                ...
                <p>Puede revisar los comentarios del revisor y realizar las correcciones necesarias. Una vez realizadas las modificaciones, podrá volver a enviar su comprobación para revisión.</p>
            </div>
        </div>
